...
public class World {
	...
	String[] tileTypes = {"grama","terra","areia","neve"};
		...
		HEIGHT = 80;
		//Divisão do Mapa
		int biomes = WIDTH/tileTypes.length;
